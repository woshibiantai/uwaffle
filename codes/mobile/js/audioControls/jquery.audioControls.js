...
!function(t,e,a,i){
    ...
    var n="audioControls", o={autoPlay:!0,
                            childElements:"li",
                            timer:"decrement",
        ...
        s.prototype={
            init:function(){
                ...
                this.playlist?(this.playlist=this.playlistSrc.slice(0),
                    ...
                    this._audio=this._player.get(0),void this.create()):!1},
            ...
            create:function(){
                ...
                this.shuffleState(),
                this.source(),0==t("audio").length&&t("body").append(this._player),
                this.getIndex()<=0&&(this.buttonPrevious=!1,
            ...
            shuffle:function(){
                ...
                if(this.arrayindex=[],t.length>0)
                    for(var e,a,i=t.length;
                        0!==i;)
                        a=Math.floor(Math.random()*i),
                    i-=1,e=t[i],t[i]=t[a],t[a]=e;
                    return t},
            ...
            source:function(e,a){
                ...
                this._player.attr({src:n,type:this.getDataType(this.playlist[e])}),
                this._player.data("audIndex",e),
                this._player.html(s),
                this.onSongChange(e),
                a!=i&&1==a&&this.play()},
            ...
            onSongChange:function(t){
                ...
                {var a={index:e,
                        ...
                        artist:this.playListObj.eq(e).find("span").text(),
                        art:this.playListObj.eq(e).find("p").text(),
                        lastUser:this.playListObj.eq(e).find("p2").text(),
                        favorites:this.playListObj.eq(e).find("p1").text(),
                        ele:this.playListObj.eq(e)};
                    this.playListObj.eq(e).find("li").text()}
            ...
            updateActiveSong:function(t){
                ...
                return this.playListObj.removeClass("activeAudio"),
                        this.playListObj.eq(e).addClass("activeAudio"),e},
            ...
            attachEvents:function(){
                ...
                this.shuffBut.on("click",function(){
                    var a=t(this);"false"==a.attr("data-state")?(a.attr("data-state","true").toggleClass("shuffle shuffleActive"),
                        e.shuffled=!0):(a.attr("data-state","false").toggleClass("shuffleActive shuffle"),e.shuffled=!1),
                        e.shuffleState()}),
                ...
                t(this._audio).on("play",function(){
                    ...
                    "function"==typeof e.opts.onPlay&&e.opts.onPlay.apply(this,[e.playPauseBut])}).on("pause",function(){
                        e.playPauseBut.removeClass("playAudio").addClass("pauseAudio"),
                        "function"==typeof e.opts.onPause&&e.opts.onPause.apply(this,[e.playPauseBut])}),
                    ...
                    t(this._audio).bind("durationchange progress",function(){
                        var t=100/(this.duration||1)*(this.seekable&&this.seekable.length?this.seekable.end(0):0)+"%";e.seekTrack.css("width",t)}),
                    ...
                    t.fn[n]=function(e){
                        return this.each(function(){
                            t.data(this,"plugin_"+n)||t.data(this,"plugin_"+n,new s(this,e))})}}(jQuery,window,document);