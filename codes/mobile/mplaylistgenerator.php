...
$sql = "SELECT Username FROM Constants";
...
$sql4 = "SELECT * FROM Favorites WHERE Username = '".$owner."'";
$result4 = $conn->query($sql4);
$favsongs = mysqli_fetch_array($result4);
...
$heart = array('assets/main/noheart.svg', 'assets/main/heart.svg');
...
foreach ($dict as $output) {
    ...
    while($row3 = $result3->fetch_assoc()) {
        echo "<li data-src='".$row3['url']."'>
                ...
                <p>".$row3['art']."</p><p2>".$output[1]."</p2><p1>".$heart[$output[2]]."</p1></li>";
    }
}
