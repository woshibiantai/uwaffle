    ...
    <div class="row header-row">
        ...
        <div class="col-xs-10 header-col dropdown">
            ...
            <div id="local-dropdown" class="dropdown-content">
                <ul>
                    <li><a href="mplayer.php">show all</a></li>
                    <li><a href="mplayerlocal.php">local</a></li>
                    <li><a href="mplayernonlocal.php">non-local</a></li>
                </ul>
            </div>
...
<!-- SONG SELECTION -->
    <div id="listContainer" class="playlistContainer">
        <ul id="playListContainer">
            <?php
            include 'mplaylistgenerator.php';
            ?>
        </ul>
    </div>
            ...
            <div class="col-xs-12 detailsMax-col">
                ...
                <div class="row controlsMax-row">
                    <div class="col-xs-2 col-xs-offset-3 playMax-col">
                        <ul class="controlsMax">
                            <a href="#" class="favoriteBtn"><img id="favorites" src="assets/main/heart.svg"></a>
        ...
        $(document).ready(function(){
            $("#playListContainer").audioControls({
                ...
                onAudioChange : function(response){
                    ...
                    document.getElementById("favorites").src = response.favorites;
