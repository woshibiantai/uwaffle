...
if(!isset($_SESSION['sess_user'])){
    header('location:indexnonlocal.php');
} else {
    ?>
<!DOCTYPE html>
<html>
...
<!-- End of MUSIC PLAYER section --> 
    ...
    <div class="player-tabs">
        <a href="local.php" id="local-tab"><img src="assets/local.svg"></a>
        <a href="nonlocal.php" id="nonlocal-tab"><img src="assets/foreign.svg"></a>
        <a href="player.php" id="player-tab"><img src="assets/all.svg"></a>
    </div>
...
** KAILUE PLS CHANGE THIS PART THANKS ** -->
    <div id="listContainer" class="playlistContainer">
        <ul id="playListContainer">
            <?php
            include 'nonlocalplaylistgenerator.php';
            ?>
        </ul>
    </div>
...
<!-- HOME BUTTON -->
    <div id="homeBtn"></div>
    <div id="home">
        <a href="five.php" id="profile"><img src="assets/profileBtn.svg"></a>
        <a href="logout.php" id="logout"><img src="assets/logBtn.svg"></a>
    </div>
<!-- end of HOME BUTTON -->
