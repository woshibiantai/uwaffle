...
$sql = "SELECT Username FROM Users WHERE nature = 'nonlocal'";
...
foreach ($dict as $output) {
    ...
    while($row3 = $result3->fetch_assoc()) {
        echo "<li data-src='".$row3['url']."'><span>".$row3['artist']."</span> - <a href='#' class='songTitle'>".$output[0]."</a><p>".$row3['art']."</p><s>".$output[1]."</s></li>";
    }
}
